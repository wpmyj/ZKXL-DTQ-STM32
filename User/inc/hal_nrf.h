...
#define CSN_LOW_2() 	GPIOB->BRR = GPIO_Pin_4
#define CSN_HIGH_2() 	GPIOB->BSRR = GPIO_Pin_4
#define CE_LOW_2() 		GPIOB->BRR = GPIO_Pin_5
#define CE_HIGH_2() 	GPIOB->BSRR = GPIO_Pin_5
